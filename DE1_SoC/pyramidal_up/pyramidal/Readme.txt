1. Compiling OPENCL Kernel  
	a. 	change the directory to device folder using "cd pyramidal_up/device/"
...
3. Copy the necessary files into a memory stick
	a.File list
		...
		ii)	pyramidal_up	- executable file
...
5. Running the OpenCL Code on DE1-SoC
	...
	b.Make sure the host program is executable by running "chmod +x ./pyramidal_up"
